...
setup(
    name="azul-plugin-netinfo",
    description="Extracts network telemetry from packet captures.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_netinfo"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-netinfo = azul_plugin_netinfo.main:main",
        ]
    },
